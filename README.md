...
* [Mudlet](https://github.com/Mudlet/Mudlet) ⭐ 910 | 🐛 764 | 🌐 C++ | 📅 2026-09-08 - A cross-platform, MUD client with scripting in Lua.
* [Blightmud](https://github.com/LiquidityC/Blightmud) ⭐ 274 | 🐛 10 | 🌐 Rust | 📅 2026-09-07 -  A mud client for the terminal
...
* JMC - Jaba MUD Client forks: [by conelav](https://github.com/konelav/jmc) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2026-07-05 and [by nerevar](https://nerevar.github.io/jmc/)
* [powwow](https://github.com/MUME/powwow) ⭐ 10 | 🐛 3 | 🌐 C | 📅 2023-01-12
* [muddle](https://github.com/gvanderest/muddle) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-03-28 - Electron-Based MUD Client
...
* [Evennia](https://github.com/evennia/evennia) ⭐ 2,097 | 🐛 129 | 🌐 Python | 📅 2026-09-09 - Python MUD/MUX/MUSH/MU\* development system.
* [Ranvier](https://github.com/shawncplus/ranviermud) ⭐ 856 | 🐛 19 | 🌐 JavaScript | 📅 2023-07-11 - Node.js-based MUD engine.
* [ExVenture](https://github.com/oestrich/ex_venture) ⚠️ Archived - Elixir based MUD engine.
* [FluffOS](https://github.com/fluffos/fluffos) ⭐ 454 | 🐛 25 | 🌐 C++ | 📅 2026-09-09 - actively maintained LPMUD driver, based on the last release of MudOS.
* [CoffeMud](https://github.com/bozimmerman/CoffeeMud) ⭐ 233 | 🐛 3 | 🌐 Java | 📅 2026-09-06 - Java-based MUD engine.
...
* [Legends of Future Past](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 45 | 🌐 HTML | 📅 2026-05-17 - 1992 commercial MUD resurrected from original script files using AI. Go backend, React frontend, WebSocket multiplayer. MIT license. [Play free](https://lofp.metavert.io).
* [ldmud](https://github.com/ldmud/ldmud) ⭐ 158 | 🐛 47 | 🌐 C | 📅 2026-02-15 - LDMud game driver for LPMuds.
...
* [tbaMUD](https://github.com/tbamud/tbamud) ⭐ 150 | 🐛 11 | 🌐 C | 📅 2026-09-08 - tbaMUD is the continued development of the codebase formerly known as CircleMUD
...
* [EmpireMUD](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 13 | 🌐 C | 📅 2026-09-10 - EmpireMUD is a MUD server with a persistent world map. It is a derivative of CircleMUD and DikuMUD.
...
* [AwakeMUD](https://github.com/luciensadi/AwakeMUD) ⭐ 77 | 🐛 12 | 🌐 C++ | 📅 2026-08-23 - Community fork of Awakened Worlds written in C++.
* [DUM](https://github.com/wowpin/dumserver) ⭐ 71 | 🐛 6 | 🌐 JavaScript | 📅 2023-09-25 - A modern Python MU\* engine.
* [BRus MUD Engine](https://github.com/bylins/mud) ⭐ 43 | 🐛 48 | 🌐 C++ | 📅 2026-09-10 - Russian MUD engine in C++.
