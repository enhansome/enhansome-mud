...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,054 | 🐛 100 | 📅 2026-06-30 list thing. You might also like [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,435 | 🐛 184 | 📅 2025-08-28 and [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,150 | 🐛 0 | 🌐 Shell | 📅 2026-08-04, which both support text-based living!*
...
* [Mudlet](https://github.com/Mudlet/Mudlet) ⭐ 902 | 🐛 580 | 🌐 C++ | 📅 2026-08-12 - A cross-platform, MUD client with scripting in Lua.
...
* [Evennia](https://github.com/evennia/evennia) ⭐ 2,085 | 🐛 126 | 🌐 Python | 📅 2026-08-09 - Python MUD/MUX/MUSH/MU\* development system.
* [Ranvier](https://github.com/shawncplus/ranviermud) ⭐ 854 | 🐛 19 | 🌐 JavaScript | 📅 2023-07-11 - Node.js-based MUD engine.
* [ExVenture](https://github.com/oestrich/ex_venture) ⚠️ Archived - Elixir based MUD engine.
* [FluffOS](https://github.com/fluffos/fluffos) ⭐ 452 | 🐛 19 | 🌐 C++ | 📅 2026-08-13 - actively maintained LPMUD driver, based on the last release of MudOS.
* [CoffeMud](https://github.com/bozimmerman/CoffeeMud) ⭐ 230 | 🐛 2 | 🌐 Java | 📅 2026-08-13 - Java-based MUD engine.
...
* [Legends of Future Past](https://github.com/jonradoff/lofp) ⭐ 181 | 🐛 24 | 🌐 HTML | 📅 2026-05-17 - 1992 commercial MUD resurrected from original script files using AI. Go backend, React frontend, WebSocket multiplayer. MIT license. [Play free](https://lofp.metavert.io).
* [ldmud](https://github.com/ldmud/ldmud) ⭐ 157 | 🐛 42 | 🌐 C | 📅 2026-02-15 - LDMud game driver for LPMuds.
...
* [EmpireMUD](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 12 | 🌐 C | 📅 2026-08-12 - EmpireMUD is a MUD server with a persistent world map. It is a derivative of CircleMUD and DikuMUD.
...
* [BRus MUD Engine](https://github.com/bylins/mud) ⭐ 43 | 🐛 29 | 🌐 C++ | 📅 2026-08-13 - Russian MUD engine in C++.
