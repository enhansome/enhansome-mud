...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,739 | 🐛 105 | 📅 2026-08-21 list thing. You might also like [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,543 | 🐛 184 | 📅 2025-08-28 and [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,295 | 🐛 2 | 🌐 Shell | 📅 2026-08-22, which both support text-based living!*
...
* [Mudlet](https://github.com/Mudlet/Mudlet) ⭐ 906 | 🐛 642 | 🌐 C++ | 📅 2026-08-31 - A cross-platform, MUD client with scripting in Lua.
* [Blightmud](https://github.com/LiquidityC/Blightmud) ⭐ 274 | 🐛 8 | 🌐 Rust | 📅 2026-08-31 -  A mud client for the terminal
...
* [Evennia](https://github.com/evennia/evennia) ⭐ 2,092 | 🐛 123 | 🌐 Python | 📅 2026-08-19 - Python MUD/MUX/MUSH/MU\* development system.
...
* [FluffOS](https://github.com/fluffos/fluffos) ⭐ 453 | 🐛 26 | 🌐 C++ | 📅 2026-08-31 - actively maintained LPMUD driver, based on the last release of MudOS.
...
* [Legends of Future Past](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 38 | 🌐 HTML | 📅 2026-05-17 - 1992 commercial MUD resurrected from original script files using AI. Go backend, React frontend, WebSocket multiplayer. MIT license. [Play free](https://lofp.metavert.io).
...
* [tbaMUD](https://github.com/tbamud/tbamud) ⭐ 150 | 🐛 98 | 🌐 C | 📅 2026-08-30 - tbaMUD is the continued development of the codebase formerly known as CircleMUD
...
* [BRus MUD Engine](https://github.com/bylins/mud) ⭐ 43 | 🐛 44 | 🌐 C++ | 📅 2026-08-31 - Russian MUD engine in C++.
