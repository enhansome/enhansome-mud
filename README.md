...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,970 | 🐛 102 | 📅 2026-06-30 list thing. You might also like [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,459 | 🐛 184 | 📅 2025-08-28 and [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,173 | 🐛 1 | 🌐 Shell | 📅 2026-08-17, which both support text-based living!*
...
* [Mudlet](https://github.com/Mudlet/Mudlet) ⭐ 902 | 🐛 574 | 🌐 C++ | 📅 2026-08-17 - A cross-platform, MUD client with scripting in Lua.
...
* [Evennia](https://github.com/evennia/evennia) ⭐ 2,086 | 🐛 127 | 🌐 Python | 📅 2026-08-17 - Python MUD/MUX/MUSH/MU\* development system.
...
* [FluffOS](https://github.com/fluffos/fluffos) ⭐ 452 | 🐛 21 | 🌐 C++ | 📅 2026-08-17 - actively maintained LPMUD driver, based on the last release of MudOS.
* [CoffeMud](https://github.com/bozimmerman/CoffeeMud) ⭐ 232 | 🐛 2 | 🌐 Java | 📅 2026-08-17 - Java-based MUD engine.
...
* [Legends of Future Past](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 30 | 🌐 HTML | 📅 2026-05-17 - 1992 commercial MUD resurrected from original script files using AI. Go backend, React frontend, WebSocket multiplayer. MIT license. [Play free](https://lofp.metavert.io).
...
* [BRus MUD Engine](https://github.com/bylins/mud) ⭐ 43 | 🐛 33 | 🌐 C++ | 📅 2026-08-17 - Russian MUD engine in C++.
