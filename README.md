...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,518 | 🐛 106 | 📅 2026-09-02 list thing. You might also like [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,641 | 🐛 186 | 📅 2025-08-28 and [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,423 | 🐛 1 | 🌐 Shell | 📅 2026-09-13, which both support text-based living!*
...
* [Mudlet](https://github.com/Mudlet/Mudlet) ⭐ 912 | 🐛 873 | 🌐 C++ | 📅 2026-09-18 - A cross-platform, MUD client with scripting in Lua.
...
* [Evennia](https://github.com/evennia/evennia) ⭐ 2,103 | 🐛 130 | 🌐 Python | 📅 2026-09-18 - Python MUD/MUX/MUSH/MU\* development system.
...
* [FluffOS](https://github.com/fluffos/fluffos) ⭐ 457 | 🐛 25 | 🌐 C++ | 📅 2026-09-16 - actively maintained LPMUD driver, based on the last release of MudOS.
* [CoffeMud](https://github.com/bozimmerman/CoffeeMud) ⭐ 233 | 🐛 3 | 🌐 Java | 📅 2026-09-18 - Java-based MUD engine.
...
* [EmpireMUD](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 13 | 🌐 C | 📅 2026-09-18 - EmpireMUD is a MUD server with a persistent world map. It is a derivative of CircleMUD and DikuMUD.
...
* [BRus MUD Engine](https://github.com/bylins/mud) ⭐ 43 | 🐛 41 | 🌐 C++ | 📅 2026-09-18 - Russian MUD engine in C++.
